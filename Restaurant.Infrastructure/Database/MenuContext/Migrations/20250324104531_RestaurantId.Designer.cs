...
namespace infrastructure.Database.MenuContext.Migrations
{
    ...
    [Migration("20250324104531_RestaurantId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("domain.Menus.ValueObjects.Category", b =>
                {
                    b.Property<int>("CategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MealCategories", b =>
                {
                    ...
                    b.HasOne("domain.Menus.ValueObjects.Category", null)
                        .WithMany()
                        .HasForeignKey("MealID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("domain.Menus.Aggregates.Menu", b =>
                {
                    b.HasOne("domain.Menus.ValueObjects.MenuRestaurant", "Restaurant")
                        .WithMany()
